...
alter table bnf_with_mapped_drugnames add column flag integer
...
-- First attempt for drug name blinding; note that some drug names have not been successfully 
-- blinded because the original name was for example the salt form of the drug
