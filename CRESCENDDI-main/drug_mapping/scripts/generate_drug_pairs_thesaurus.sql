...
drop table if exists thesaurus_drug_pairs;
create table thesaurus_drug_pairs as
select distinct ordered_drug_list from thesaurus_with_mapped_drugnames;

alter table thesaurus_drug_pairs
add column drug_1_concept_id integer,
add column drug_2_concept_id integer;

update thesaurus_drug_pairs
