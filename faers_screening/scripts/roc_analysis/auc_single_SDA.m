...
% This script calculates AUC scores for the single-drug signal detection algorithms (i.e. PRR, EBGM, BCPNN)
...
intersect_clt_tbl = singledrugresourceintersectscores(:,{'No','SOURCE','PRR','EBGM','Q_0025logIC','indicator', 'N'});
